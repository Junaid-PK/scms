...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFrom = "`attendance` LEFT JOIN `students` as students1 ON `students1`.`regno`=`attendance`.`student` LEFT JOIN `units` as units1 ON `units1`.`id`=`attendance`.`unit` LEFT JOIN `academic_year` as academic_year1 ON `academic_year1`.`id`=`students1`.`academicyear` ";
	$x->QueryWhere = '';
	$x->QueryOrder = '';
	...
	$x->ColCaption = array("Student", "Regno", "Week", "Date", "Unit", "Attended", "Semester", "Academicyear");
	$x->ColFieldName = array('student', 'regno', 'week', 'date', 'unit', 'attended', 'semester', 'academicyear');
	$x->ColNumber  = array(1, 2, 3, 4, 5, 6, 8, 9);
