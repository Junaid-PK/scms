...
*/
	...
	$lookups = array(   
		'students' => array(   
			...
			'academicyear' => array(
				'parent_table' => 'academic_year',
				'parent_pk_field' => 'id',
				'parent_caption' => '`academic_year`.`name`',
				'parent_from' => '`academic_year` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
		...
		'attendance' => array(   
			'student' => array(
				...
				'parent_from' => '`students` LEFT JOIN `courses` as courses1 ON `courses1`.`id`=`students`.`course` LEFT JOIN `academic_year` as academic_year1 ON `academic_year1`.`id`=`students`.`academicyear` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
			...
			'academicyear' => array(
				'parent_table' => 'students',
				'parent_pk_field' => 'regno',
				'parent_caption' => 'IF(    CHAR_LENGTH(`academic_year1`.`name`), CONCAT_WS(\'\',   `academic_year1`.`name`), \'\')',
				'parent_from' => '`students` LEFT JOIN `courses` as courses1 ON `courses1`.`id`=`students`.`course` LEFT JOIN `academic_year` as academic_year1 ON `academic_year1`.`id`=`students`.`academicyear` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => false,
