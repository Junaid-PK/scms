...
// academic_year table
academic_year_addTip=["",spacer+"This option allows all members of the group to add records to the 'Academic year' table. A member who adds a record to the table becomes the 'owner' of that record."];

academic_year_view0Tip=["",spacer+"This option prohibits all members of the group from viewing any record in the 'Academic year' table."];
academic_year_view1Tip=["",spacer+"This option allows each member of the group to view only his own records in the 'Academic year' table."];
academic_year_view2Tip=["",spacer+"This option allows each member of the group to view any record owned by any member of the group in the 'Academic year' table."];
academic_year_view3Tip=["",spacer+"This option allows each member of the group to view all records in the 'Academic year' table."];

academic_year_edit0Tip=["",spacer+"This option prohibits all members of the group from modifying any record in the 'Academic year' table."];
academic_year_edit1Tip=["",spacer+"This option allows each member of the group to edit only his own records in the 'Academic year' table."];
academic_year_edit2Tip=["",spacer+"This option allows each member of the group to edit any record owned by any member of the group in the 'Academic year' table."];
academic_year_edit3Tip=["",spacer+"This option allows each member of the group to edit any records in the 'Academic year' table, regardless of their owner."];

academic_year_delete0Tip=["",spacer+"This option prohibits all members of the group from deleting any record in the 'Academic year' table."];
academic_year_delete1Tip=["",spacer+"This option allows each member of the group to delete only his own records in the 'Academic year' table."];
academic_year_delete2Tip=["",spacer+"This option allows each member of the group to delete any record owned by any member of the group in the 'Academic year' table."];
academic_year_delete3Tip=["",spacer+"This option allows each member of the group to delete any records in the 'Academic year' table."];
